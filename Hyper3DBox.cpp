...
void gameMain(MSG msg){
	...
	TextOut(hdc,0,20,"J,K,L,I,N,M¨°??¡¥??¨¬?",19);
	TextOut(hdc,0,40,"UP,DOWN,LEFT,RIGHT,Z,X¨°??¡¥?¨¤?¨²",30);
	TextOut(hdc,0,60,"A,S,D,WDy¡Áa??¨¬?",15);
...
//
LPSTR str="222";
LPCSTR str1("C:\\Users\\mrzhang\\Desktop\\???t\\¡À¨¤3¨¬\\¡Á??o¦Ì?¡ä¨²??\\???¡¤\\res\\qi.bmp");
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	switch (message) 
	{
		...
		case WM_CREATE:{
			...
			LPCSTR str="C:\\Users\\mrzhang\\Desktop\\???t\\¡À¨¤3¨¬\\¡Á??o¦Ì?¡ä¨²??\\???¡¤\\res\\qi.bmp";
			//??¦Ì??¡ã???o3???¦Ì?DC
			HDC hdc1=GetDC(hWnd);
			//¡Á¡ã????¨ª?
			...
			//scene.init_texbitmap("C:\\Users\\mrzhang\\Desktop\\???t\\¡À¨¤3¨¬\\¡Á??o¦Ì?¡ä¨²??\\???¡¤\\res\\qi.bmp");
					   }
			break;
		case WM_COMMAND:
			wmId    = LOWORD(wParam); 
